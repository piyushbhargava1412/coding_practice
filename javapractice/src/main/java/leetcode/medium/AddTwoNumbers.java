...
import static main.java.leetcode.common.ListNode.createList;
...
public class AddTwoNumbers {
  ...
  public static void main(String[] args) {
    ...
    int[] list2 = { 9, 9, 9, 9 };
    System.out.println(
      processor.addTwoNumbers(createList(list1), createList(list2))
    );
  }
  ...
  public ListNode addTwoNumbers(ListNode l1, ListNode l2) {
    ...
    if (sum < 10) output = new ListNode(sum, null); else {
